...
import { PolkaSpool } from '../../PolkaSpool'
 ...
 *
 * @see {@link http://polkajs.com/en/4x/api.html#req}
 */
export class TapestryController extends Controller {
  create(req: Request, res: Response) {
    ...
    const spoolPolka = this.app.spools.polka as PolkaSpool
    const options = spoolPolka.getOptionsFromQuery(req.query)
  ...
  find(req: Request, res: Response) {
    ...
    const spoolPolka = this.app.spools.polka as PolkaSpool
    const options = spoolPolka.getOptionsFromQuery(req.query)
    const criteria = spoolPolka.getCriteriaFromQuery(req.query)
